...
export default function Footer() {
   return (
      ...
      <footer class="bg-dark pt-3 pt-lg-5" style={{ marginTop: "280px" }}>

         <div class="container text-left position-relative" style={{ marginTop: "120px" }} >

            <div class="ciswp-footer ps-3">
               ...
               <div class="container text-left">
                  ...
                  <div class="row m-auto" >
                     <div class="col m-auto">
                        <p>
                           <img style={{ width: "280px" }} src="img/ciswp-full-logo.png" alt="CISWP" />
                        </p>
                        <p>Connect with the Canadian Institute for Safety, Wellness &amp; Performance to discuss research opportunities and partnerships.&nbsp;</p>
                        <h5>Contact us</h5>

                        <div> <img src="img/f_icon_mail.png" alt="" height="25" />
                           <a href="mailto:ciswp@conestogac.on.ca"
                              class="text-decoration-none" style={{ color: "#087D73" }}>ciswp@conestogac.on.ca</a>
                           &nbsp;&nbsp;&nbsp;
                           <img src="img/f_icon_phone.png" alt="" height="25" />
                     ...
                     <div class="col m-auto"  >
                        ...
                        <img class="ciswp_footer_map" src="img/ciswp_map.png" />
                     </div>
