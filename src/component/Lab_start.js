...
export default function Lab_start() {
   ...
   function onMouseEnterHandler1() {
      const box = document.querySelector("#stride_explore_focus1");
      const focus_box = document.querySelector("#stride_explore_focus1_box");
      box.firstChild.src = "./img/labs/stride_qu_focus.png";
   ...
   function onMouseLeaveHandler1() {
      const box = document.querySelector("#stride_explore_focus1");
      const focus_box = document.querySelector("#stride_explore_focus1_box");
      box.firstChild.src = "./img/labs/stride_qu_default.png";
      focus_box.classList.remove("on");
   }

   function onMouseEnterHandler2() {
      const box = document.querySelector("#stride_explore_focus2");
      const focus_box = document.querySelector("#stride_explore_focus2_box");
      box.firstChild.src = "./img/labs/stride_qu_focus.png";
      focus_box.classList.add("on");
   }
   ...
   function onMouseEnterHandler3() {
      const box = document.querySelector("#stride_explore_focus3");
      const focus_box = document.querySelector("#stride_explore_focus3_box");
      box.firstChild.src = "./img/labs/stride_qu_focus.png";
      focus_box.classList.add("on");
   ...
   function onMouseEnterHandler4() {
      const box = document.querySelector("#stride_explore_focus4");
      const focus_box = document.querySelector("#stride_explore_focus4_box");
      box.firstChild.src = "./img/labs/stride_qu_focus.png";
      focus_box.classList.add("on");
   ...
   return (
      <div class="container-fluid p-0">
         ...
         <div class="container mt-5">
            ...
            <h3>Our STRART Lab Features</h3>

            <div class="row">
               <div class="col-6 p-0"><Lab_start_slide /> </div>
               <div class="col-6 pe-4">

                  <div class="stride_card_grid">
                     <div class="stride_card">
                        <img src="./img/labs/stride_eq_camera.png" class="card-img-top" alt="" />
                        <div class="stride_card_body">
                           <div class="stride_card_text">
                              A 10-camera high fidelity motion capture system</div>
                        </div>
                     </div>
                     <div class="stride_card">
                        <img src="./img/labs/stride_eq_muscle.png" class="card-img-top" alt="" />
                        <div class="stride_card_body">
                           <div class="stride_card_text">
                     ...
                     <div class="stride_card">
                        <img src="./img/labs/stride_eq_suite.png" class="card-img-top" alt="" />
                        <div class="stride_card_body">
                           <div class="stride_card_text">
                     ...
                     <div class="stride_card">
                        <img id="stride_card_img2" src="./img/labs/stride_eq_force.jpg" class="card-img-top" alt="" />
                     </div>
            ...
            <div class="stride_explore">
               <img src="img/labs/stride_ex_room.png" alt="..." />
               <div id="stride_explore_focus1"
                  onMouseEnter={onMouseEnterHandler1}
                  onMouseLeave={onMouseLeaveHandler1}>
                  <img src="./img/labs/stride_qu_default.png" alt="" />
               </div>
               <div id="stride_explore_focus1_box">
                  <img src="./img/labs/stride_eq_camera2.png" />
                  <div class="stride_focus_text">
                     Vicon Camera</div>
                  <div class="stride_focus_text_desc">
                     A 10-camera high fidelity motion capture system</div>
               </div>

               <div id="stride_explore_eq2">
                  <img src="./img/labs/stride_ex_room_suite.png" alt="" />
               </div>

               <div id="stride_explore_focus2"
                  onMouseEnter={onMouseEnterHandler2}
                  onMouseLeave={onMouseLeaveHandler2}>
                  <img src="./img/labs/stride_qu_default.png" alt="" />
               </div>
               <div id="stride_explore_focus2_box">
                  <img src="./img/labs/stride_eq_suite2.jpg" />
                  <div class="stride_focus_text">
                     Load Cell Amp</div>
                  <div class="stride_focus_text_desc">
                     A suite of force measuring equipment including force plates</div>
               ...
               <div id="stride_explore_eq3">
                  <img src="./img/labs/stride_ex_room_muscle.png" alt="" />
               </div>

               <div id="stride_explore_focus3"
                  onMouseEnter={onMouseEnterHandler3}
                  onMouseLeave={onMouseLeaveHandler3}>
                  <img src="./img/labs/stride_qu_default.png" alt="" />
               </div>
               <div id="stride_explore_focus3_box">
                  <img src="./img/labs/stride_eq_muscle2.jpg" />
                  <div class="stride_focus_text">
               ...
               <div id="stride_explore_focus4"
                  onMouseEnter={onMouseEnterHandler4}
                  onMouseLeave={onMouseLeaveHandler4}>
                  <img src="./img/labs/stride_qu_default.png" alt="" />
               </div>
               <div id="stride_explore_focus4_box">
                  <img src="./img/labs/stride_eq_vicon2.png" />
                  <div class="stride_focus_text">
                     Vicon POE</div>
                  <div class="stride_focus_text_desc">
   ...
   function Lab_start_slide() {
      return (
         <Carousel
            ...
            width={"100%"}
         >
            <div class="stride_slide_img ">
               <img src="img/labs/stride_slide1.jpg" />
            </div>
            <div class="stride_slide_img">
               <img src="img/labs/stride_slide2.jpg" />
            </div>
            <div class="stride_slide_img">
               <img src="img/labs/stride_slide3.jpg" />
            </div>
         </Carousel >
